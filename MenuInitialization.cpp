...
void loadMenuUI() {
    ...
    logo->SetScale((float)SCREEN_HEIGHT/1440);
    ...
    playButton->SetScale((float)SCREEN_HEIGHT/1440);
    playButton->SetCenter(SCREEN_WIDTH/2,SCREEN_HEIGHT/3 * 2 - 40);
    ...
    settingsButton->SetScale((float)SCREEN_HEIGHT/1440);
    ...
    quitButton->SetScale((float)SCREEN_HEIGHT/1440);
...
void loadMenuBackground() {
    ...
    background->SetScale((float)SCREEN_HEIGHT/1440);
